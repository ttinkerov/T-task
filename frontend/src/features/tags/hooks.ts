...
function invalidateTaskViews(queryClient: ReturnType<typeof useQueryClient>, workspaceId: string) {
...
export function useSetTaskTagsMutation(workspaceId: string, taskId: string) {
  const queryClient = useQueryClient();
  return useMutation({
