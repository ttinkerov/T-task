    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/dashboard/epic-board', label: 'Эпики', iconKey: 'sticky' },
          { href: '/dashboard/whiteboard', label: 'Whiteboard', iconKey: 'pen' },
          ...
          { href: '/dashboard/dod', label: 'Чеклисты', iconKey: 'checks' },
