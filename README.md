...
- **Roadmap / Epic-борд / Фокус** — планирование и концентрация
- **CRM** — воронки, сделки, связь со задачами
- **Forms** — публичные формы → задачи / сделки
- **Критерии готовности / Templates** — чеклисты и шаблоны карточек
- **Analytics** — throughput, cycle time, workload
- **Календарь / Импорт / AI / Корзина** — iCal-фид, CSV, RAG-помощник, soft-delete
